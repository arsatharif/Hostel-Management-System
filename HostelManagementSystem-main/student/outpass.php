...
$errmsg="*You entered wrong information";
  ...
  $errmsg="*You already had a leave";
   ...
   require_once('../dbConnect.php');
 $sql="INSERT INTO `outpass` (`name`,`regno`,`block`,`roomno`,`fromdate`,`todate`,`reason`,`status`)VALUES ('$name','$regno','$block','$roomno','$fromdate','$todate','$reason','Pending')";
...
<body>
  <div class="container">
    <div class="title">OUTPASS FORM</div>
    <div class="content">
      <form action="outpass.php" method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" name="fromdate" id="fromdate" placeholder="Enter from time " required>
          </div>
          <div class="input-box">
            <span class="details">In time</span>
            <input type="text" name="todate" id="todate" placeholder="Enter to time"  required>
          </div>
          <div class="input-box">
