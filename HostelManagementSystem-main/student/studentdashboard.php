...
<html lang="en" dir="ltr">
  <head>
    ...
    <script type="text/javascript">
      ...
      function leaveformstatus(){
        window.location.href ="leaveformstatus.php";
...
<div class="wrapper">
   ...
   <div class="content">
      ...
      <!-- card -->
      <div class="card" onclick="leaveformstatus()">
      ...
      <!-- card -->
      <div class="card" onclick="outpass()">

            <div class="icon"><i class="material-icons md-36"></i></div>
            <p class="title">Outpass</p>
            <p class="text">Apply outpass.</p>

      </div>
      <!-- end card -->

      <!-- card -->
      <div class="card" onclick="attendance()">

            <div class="icon"><i class="material-icons md-36"></i></div>
            <p class="title">Attendance</p>
            <p class="text">Attendance Register.</p>
