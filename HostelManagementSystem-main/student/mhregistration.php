...
<article class="card card--1">
  ...
  <div class="card__info">
    ...
    <h3 class="card__title">8th Floor</h3>
    <!-- <span class="card__by"> <a href="#" class="card__author" title="author">select</a></span> -->
    <input type="submit" name="8th Floor" id="8th Floor" class="card__by" value="submit">
    <!-- <button type="button" name="button" class="card__by" onclick="select('8th Floor')">Select</button> -->
  </div>
</article>
...
<article class="card card--2">
  ...
  <div class="card__info">
    <span class="card__category"> BOYS Hostel</span>
    <h3 class="card__title">Butterfly Hostel</h3>
...
<article class="card card--3">
  ...
  <div class="card__info">
    <span class="card__category"> BOYS Hostel</span>
    <h3 class="card__title">Titanic Hostel</h3>
...
<article class="card card--4">
  ...
  <div class="card__info">
    <span class="card__category"> BOYS Hostel</span>
    <h3 class="card__title">Common Hostel</h3>
...
<article class="card card--5">
  ...
  <div class="card__info">
    <span class="card__category"> DSU Hostel</span>
